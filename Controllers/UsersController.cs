...
namespace Labmaintanance2.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "user_id,username,email,role_id")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "user_id,username,email,role_id")] User user)
        {
            if (ModelState.IsValid)
            {
